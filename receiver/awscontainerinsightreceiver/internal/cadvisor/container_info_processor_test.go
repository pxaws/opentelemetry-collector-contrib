...
func TestProcessContainers(t *testing.T) {
	...
	podInfos := testutils.LoadContainerInfo("./extractors/testdata/InfoPod.json")
	containerInfos = append(containerInfos, podInfos...)
	containerInContainerInfos := testutils.LoadContainerInfo("./extractors/testdata/ContainerInContainer.json")
