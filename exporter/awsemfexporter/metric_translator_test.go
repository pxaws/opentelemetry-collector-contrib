...
func TestTranslateCWMetricToEMF(t *testing.T) {
	...
	config := &Config{
		//include a non-existing key and a key whose value are not json
		ParseJSONEncodedAttributeValues: []string{"kubernetes", "Sources", "NonExistingAttributeKey", "spanName"},
	}
